...
<form class="filterBar alt" id="filterBar" method="get" action="<?php echo site_url('inventory'); ?>" onkeypress="return event.keyCode != 13;">
  <div class="filterBarTop">
    <div class="filterButton" onclick="altClassFromSelector('alt', '#filterBar')">
      ...
      <svg width="50" height="50" viewBox="0 0 100 85" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle class="filterButtonCircle" cx="23.5057" cy="74.318"  r="9.81672" transform="rotate(-90 23.5057 74.3180)" fill="black"/>
    ...
    <div class="mateput">
      <input class="mateputInput" id="searchInput" type="text" name="filter_search" autocomplete="off" value="<?php if(isset($_GET['filter_search']) AND $_GET['filter_search']!=''){echo $_GET['filter_search'];}?>">
    ...
    <a href="<?php echo get_permalink( woocommerce_get_page_id( 'shop' ) ); ?>" class="filterBarLink">inventory</a>
    <a href="<?php echo get_permalink( woocommerce_get_page_id( 'shop' ) ).'?auction=true'; ?>" class="filterBarLink">auctions</a>
    <a href="<?php echo get_permalink( woocommerce_get_page_id( 'shop' ) ).'?sold=true'; ?>" class="filterBarLink">sold</a>
  </div>
