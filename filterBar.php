...
<form class="filterBar alt" id="filterBar" method="get" action="<?php echo site_url('inventory'); ?>">
  <div class="filterBarTop">
    ...
    <a href="<?php echo site_url('shop'); ?>" class="filterBarLink">inventory</a>
    <a href="<?php echo site_url('shop').'?auction=true'; ?>" class="filterBarLink">auctions</a>
    <a href="<?php echo site_url('shop').'?status=sold'; ?>" class="filterBarLink">sold</a>
  </div>
