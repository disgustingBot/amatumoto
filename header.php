  ...
  <header class="header loading" id="header">
    ...
    <nav class="upperNav">
      <div class="socialMedia">
        <a href="https://es-la.facebook.com/gpmotorbikes/" target="_blank" class="socialMediaLink socialMediaInst">
        ...
        <a href="https://www.instagram.com/gpmotorbikes/?hl=es" target="_blank" class="socialMediaLink socialMediaFace">
    ...
    <nav class="mobileNav" id="mobileNav">
      ...
      <div class="upperNavMobile">
        ...
        <div class="socialMediaMobile">
          ...
          <a href="" class="socialMediaLinkMobile socialMediaWhatsappMobile">
            <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
