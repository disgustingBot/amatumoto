...
<?php while(have_posts()){the_post(); ?>
  ...
  <article class="singlePage">
    ...
    <div class="singleSide">
      ...
      <div class="singleSideSintBox">
        <img src="<?php echo get_the_post_thumbnail_url(get_the_ID()); ?>" alt="">
        <?php   foreach ($terms as $term) {

              echo '<h5 itemprop="name" class="productCategoryTitle entry-title">'.$term->name.'</h5>';
          }?>
          ...
          <a href="tel:+34-938-364-911" class="singleSideContact">CALL</a>
          ...
          <div class="singleSideSocialCont">
            ...
            <a class="singleSocialLink" href="mailto:Info@gpmotorbikes.com" class="singleSocialLink">
