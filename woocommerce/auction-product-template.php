...
<article class="singlePage">
  <div class="auctionATFContainer">
    <div class="auctionMediaContainer">
      <div class="singleSideData auctionSideData onlyMobileG">
      ...
      <div class="gallery" id="gallery">
        <span class="newArrival auctionNewArrival"><i>New arrival</i></span>
    ...
    <div class='auction-ajax-change auctionDetail' >
      ...
      <?php if ( 'yes' !== $product->get_auction_sealed() ) { ?>
        <h2 class="auctionTitle">Auction info:</h2>
  ...
  <div class="auctionOtherStuff">
    <div class="acutionOtherStuffAside">
      <div class="singleSideData auctionSideData onlyDesktopG">
        <?php if (method_exists($product,'get_condition')) { ?>
          <br>Condition: <?php echo esc_html( $product->get_condition() ); ?>
        <?php } ?>
        <?php the_excerpt(); ?>
      ...
      <div class="onlyDesktopF testimonialsContainer <?php echo $clase; ?>">
        <?php
        $args = array(
          'post_type'=>'testimonials',
          'orderby'=>'rand',
        ...
        <figure class="singleSideSintBox">
          ...
          <figcaption class="singleSideSintBoxCaption">
            <h4 class="singleSideAnoMarca">
              <?php if ( $yearBike ) { echo "<span>$yearBike</span>"; } ?>
              <?php if ( $brand    ) { echo "<span>$brand</span>";    } ?>
            </h4>
    ...
    <main class="singleDescription auctionMain">
