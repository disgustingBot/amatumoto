<article class="singlePage">
  ...
  <div class="auctionATFContainer">
    ...
    <div class="auctionName">
      <?php
      if($categories){ ?>
      <span class="singleSideAnoMarca auctionMarca">
    ...
    ?>
      ...
      <span class="singleSideAnoMarca auctionAno">
        <?php
        if($categories){ ?>
        <span class="singleSideAnoMarca auctionAno">
          <?php foreach ($categories as $cat) {
  ...
  <div class="singleMain">
    ...
    <div class="singleSide singleSide2">
      <div class="singleSideData onlyDesktopG">
