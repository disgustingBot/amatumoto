  ...
  <article class="singlePage">
    ...
    <div class="singleSide singleSide1">
      ...
      <div class="singleSideSocialCont socialMedia">
        ...
        <a href="tel:+34 938 364 911" target="_blank" class="socialMediaLink socialMediaPhone">
    ...
    <div class="singleMain">
      ...
      <div class="singleFeatures">
        ...
        <figure class="singleFeature">
          ...
          <?php $breaks = get_post_meta( $product->id, 'breaks' )[0]; ?>
          <?php if($breaks){ ?>
              <p class="singleFeatureDesc"><?php echo $breaks; ?></p>
          <?php } ?>
